    ...
    <div className="bg-[#FAF9F9] text-gray-800">
      ...
      <div className="min-h-[60vh] flex flex-col justify-center items-center text-center px-6">
        ...
        >
          ...
          Our AI solutions help businesses improve efficiency, gain insights,
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 text-center">
        ...
        <p className="text-lg text-gray-600 leading-relaxed">
          We design and develop intelligent applications powered by modern AI technologies.
          From predictive analytics and automation to chatbots and computer vision systems,
          we deliver scalable, secure, and high-performance AI solutions tailored to your needs.
        </p>
      </div>
